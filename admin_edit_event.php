...
$event_time = $event["event_time"] ? substr($event["event_time"], 0, 5) : "";
            ...
            <div class="admin-form-card">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="admin-form-group admin-checkbox-group">
                        <label>
                            <input type="checkbox" name="make_active" <?php echo $is_active ? "checked" : ""; ?>>
                            Make this the active event
                        </label>
                        <small class="admin-file-help">Only one event can be active at a time.</small>
                    </div>
